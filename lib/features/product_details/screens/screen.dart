...
import 'package:amazon_clone/features/product_details/services/product_details.dart';
...
class ProductDeals extends StatefulWidget {
  static const String routeName = '/product-deals';
  final Product product;
  const ProductDeals({Key? key, required this.product}) : super(key: key);
